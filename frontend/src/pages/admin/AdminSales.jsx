    ...
    <div className="min-h-screen bg-gray-950 p-4 text-white md:p-6">
      <div className="mx-auto max-w-7xl space-y-7">
        ...
        <div className="flex flex-col justify-between gap-4 sm:flex-row sm:items-center">
          ...
          <div className="flex items-center gap-2 rounded-xl border border-gray-800 bg-gray-900 px-4 py-2 text-sm text-gray-400">
        ...
        <div className="grid grid-cols-1 gap-4 sm:grid-cols-2 lg:grid-cols-4">
          {statCards.map((card, index) => {
            ...
            return (
              <div
                key={index}
                className="group relative overflow-hidden rounded-2xl border border-gray-800 bg-gray-900/80 p-5 shadow-lg backdrop-blur-md transition-all duration-300 hover:-translate-y-1 hover:border-gray-700 hover:shadow-2xl"
              >
                {/* Glow */}
                ...
                <div className="relative flex items-start justify-between">
                  ...
                  <div className="rounded-xl border border-gray-700 bg-gray-800 p-3 transition-all duration-300 group-hover:scale-110 group-hover:border-blue-500/40 group-hover:bg-blue-500/10">
        ...
        <div className="overflow-hidden rounded-2xl border border-gray-800 bg-gray-900/80 shadow-2xl backdrop-blur-md">
          ...
          {/* Chart */}
          {data.sales.length > 0 ? (
            <div className="h-[380px] w-full p-4 pt-8 md:p-6">
            ...
            <div className="flex h-80 flex-col items-center justify-center">
              <TrendingUp className="mb-3 h-10 w-10 text-gray-700" />
