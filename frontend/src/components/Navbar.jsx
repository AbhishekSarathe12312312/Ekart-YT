        ...
        <div className="flex items-center gap-2 sm:gap-3">
          ...
          {user ? (
            <button
              ...
              className="cursor-pointer rounded-xl border border-red-900/70 bg-red-950/70 px-3 py-2 text-sm font-semibold text-red-400 shadow-sm transition-all duration-300 hover:-translate-y-0.5 hover:border-red-700 hover:bg-red-900 hover:text-red-200 hover:shadow-lg active:scale-95 sm:px-4"
            >
              Logout
            </button>
          ) : (
            <button
              ...
              className="cursor-pointer rounded-xl bg-white px-4 py-2 text-sm font-bold text-black shadow-md transition-all duration-300 hover:-translate-y-0.5 hover:bg-gray-200 hover:shadow-xl active:scale-95 sm:px-5"
            >
              Login
            </button>
          )}
